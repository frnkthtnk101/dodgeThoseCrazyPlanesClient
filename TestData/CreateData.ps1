$Data1 = @{
    ...
    "Data" = @{
        ...
        "level" = (
            ...
            @{"tick" = 20; "enemies" = "lefters"; "number" =3},
            @{"tick" = 30; "enemies" = "righters"; "number" =1},
            @{"tick" = 40; "enemies" = "downers"; "number" =5},
            @{"tick" = 50; "enemies" = "lefters"; "number" =5},
            ...
            @{"tick" = 300; "enemies" = "righters"; "number" =2},
            @{"tick" = 310; "enemies" = "downers"; "number" =3},
            @{"tick" = 320; "enemies" = "lefters"; "number" =1},
            @{"tick" = 330; "enemies" = "righters"; "number" =3},
            @{"tick" = 400; "enemies" = "downers"; "number" =1},
            @{"tick" = 500; "enemies" = "lefters"; "number" =1},
            @{"tick" = 600; "enemies" = "righters"; "number" =4},
